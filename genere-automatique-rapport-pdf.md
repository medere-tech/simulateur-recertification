...
node -e "const d=require('./rapport-test.json'); require('fs').writeFileSync('rapport-v11.pdf', Buffer.from(d.pdf, 'base64')); console.log('PDF sauvegardé : rapport-v11.pdf (' + Math.round(d.pdf.length * 0.75 / 1024) + ' KB)');"
